        ...
        <div className="container">
            ...
            <div className="experiences">
                <Experience title="DMS" startDate="July. 2019" endDate="Oct. 2019" projectType={projectTypes.gmo}>
                    ...
                    <ul>
                        <li>
                            Worked as a solo developer to create React Native application and communicate with back-end
                            team to implements APIs.
                        </li>
                ...
                <Experience title="JACCS" startDate="Apr. 2019" endDate="Jun. 2019" projectType={projectTypes.gmo}>
                    ...
                    <ul>
                        ...
                        <li>
                            Implement features such as receiving notifications, loading screen, loading animations,
                            querry sorting.
                        </li>
                ...
                <Experience title="Yakult" startDate="Jun. 2019" projectType={projectTypes.gmo}>
                    ...
                    <ul>
                        <li>Worked in a team of 5 developers. Deliver the product in 3 weeks.</li>
                        <li>
                            Implement features such as receiving notifications, loading screen, animations, map
                            tracking.
                        </li>
                        <li>Contributed to features suggestion and bug fixing.</li>
                    </ul>
